...
public class UnoNetworkManager : NetworkManager
{
    ...
    public static UnoNetworkManager Singleton => (UnoNetworkManager)NetworkManager.singleton;
    ...
    public override void OnServerAddPlayer(NetworkConnectionToClient conn)
    {
        ...
        // Ensure the player has a PlayerRoom component if the prefab contains it
        if (conn.identity != null)
        {
            var pr = conn.identity.GetComponent<PlayerRoom>();
            if (pr == null)
            {
                // Not all player prefabs may have PlayerRoom; log for debug
                Debug.LogWarning("UnoNetworkManager: Player object does not contain PlayerRoom component.");
            }
        }
    }
    ...
    public override void OnServerDisconnect(NetworkConnectionToClient conn)
    {
        ...
        {
            RoomManager.Instance.RemovePlayer(conn);
        }
